...
class AppConstants {
  static const String appName = 'FORYOU RIDE';
  static const String baseUrl = 'https://ride.foryoupakistan.online';
  static const String appVersion = '1.7';
  static const Color lightPrimary = Color(0xFFFF8000);
  static const Color darkPrimary = Color(0xffff8000);
  ...
  LanguageModel(imageUrl: Images.saudi, languageName: 'Urdu', countryCode: 'PK', languageCode: 'ur'),
  ];
