...
class AppConstants {
  static const String appName = 'FORYOU';
  static const double appVersion = 2.8;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://web.foryoupakistan.online';

  static const String baseUrl = 'https://foryoupakistan.online';
  ...
  ///modules..
  static const String pharmacy = 'services';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'اردو', countryCode: 'PK', languageCode: 'ur'),
